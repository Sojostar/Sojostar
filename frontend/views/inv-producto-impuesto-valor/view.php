...
$this->title = $model->inv_producto_impuesto_valor_id;
$this->params['breadcrumbs'][] = ['label' => 'Inv Producto Impuesto Valors', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>
<div class="inv-producto-impuesto-valor-view">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Update', ['update', 'id' => $model->inv_producto_impuesto_valor_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->inv_producto_impuesto_valor_id], [
